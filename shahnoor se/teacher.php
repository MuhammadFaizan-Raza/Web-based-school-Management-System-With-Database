...
if (isset($_POST['submit'])) {
    header("Location:teachers attendance mark.php");
    exit();
}
?>
<!DOCTYPE html>
...
body {
    ...
    <script>
        function generateCourseTable() {
            ...
            if ((selectedClass === "1" || selectedClass === "2" || selectedClass === "3" || selectedClass === "4" || selectedClass === "5") &&
                (selectedSection === "Section A" || selectedSection === "Section B" || selectedSection === "Section C" || selectedSection === "Section D")) {
                courses = ["English Grammar", "English Text", "Mathematics", "Urdu", "Islamiyat", "Science", "Arts"];
            } else if ((selectedClass === "6" || selectedClass === "7") &&
                (selectedSection === "Section A" || selectedSection === "Section B" || selectedSection === "Section C" || selectedSection === "Section D")) {
            ...
            } else if ((selectedClass === "9 Arts Group" || selectedClass === "9 Science Group") &&
                (selectedSection === "Section A" || selectedSection === "Section B" || selectedSection === "Section C" || selectedSection === "Section D")) {
                courses = ["English", "Urdu", "Islamiyat", "Chemistry", "Biology / Computer Science", "Mathematics", "Physics"];
            } else if ((selectedClass === "10 Arts Group" || selectedClass === "10 Science Group") &&
                (selectedSection === "Section A" || selectedSection === "Section B" || selectedSection === "Section C" || selectedSection === "Section D")) {
            ...
            for (var i = 0; i < courses.length; i++) {
                ...
                tdCourse.textContent = courses[i];
                ...
                button.addEventListener("click", function() {
                    window.location.href = "teachers attendance mark.php"; 
                });
...
<div id="part_2">
<p class="main_para" id="intro_1"><strong>Teacher</strong></p>
</div> 
<body>
    <h1></h1>
